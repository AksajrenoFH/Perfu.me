            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-extrabold text-black tracking-tight">
                        Detail <span class="text-[#D4AF37]">Pesanan #<?php echo e($order->id); ?></span>
                    </h2>
                    <p class="text-sm text-gray-500 mt-1"><?php echo e($order->created_at->format('d M Y, H:i')); ?> WIB</p>
                </div>
                <div class="flex items-center gap-2">
                    <a href="<?php echo e(route('orders.edit', $order)); ?>" class="px-4 py-2 bg-black text-white rounded-xl text-xs font-bold hover:bg-[#D4AF37] transition">Edit Pesanan</a>
                    <a href="<?php echo e(route('orders.index')); ?>" class="px-4 py-2 bg-white border border-gray-300 rounded-xl text-xs font-bold text-gray-700 hover:bg-gray-50 transition">Kembali</a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl border border-gray-100 p-6 sm:p-8 shadow-xs space-y-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-2xl bg-gray-50 border border-gray-100">
                    ...
                    <div class="sm:text-right">
                        ...
                        <div class="text-2xl font-black text-gray-900 mt-0.5">Rp <?php echo e(number_format($order->total_price, 0, ',', '.')); ?></div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                    <div class="p-4 bg-gray-50/70 rounded-2xl border border-gray-100">
                        ...
                        <div class="font-bold text-gray-900 text-sm mt-1"><?php echo e($order->customer_name ?: 'Pelanggan Online (WhatsApp)'); ?></div>
                    </div>
                    <div class="p-4 bg-gray-50/70 rounded-2xl border border-gray-100">
                        <span class="text-[10px] font-black uppercase tracking-wider text-gray-400">Kontak Telepon / WhatsApp</span>
                        <div class="mt-1">
                            <?php if($order->customer_phone): ?>
                                <?php $phoneClean = preg_replace('/[^0-9]/', '', $order->customer_phone); ?>
                                <a href="https://wa.me/<?php echo e($phoneClean); ?>" target="_blank" class="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-600 hover:text-emerald-700">
                                    ...
                                    <?php echo e($order->customer_phone); ?> (Chat WhatsApp)
                                </a>
                            <?php else: ?>
                ...
                <?php if($order->customer_address): ?>
                    <div class="p-4 bg-gray-50/70 rounded-2xl border border-gray-100">
                        ...
                        <div class="text-xs font-semibold text-gray-700 mt-1 whitespace-pre-line"><?php echo e($order->customer_address); ?></div>
                    </div>
                <?php endif; ?>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <?php if(is_array($order->items)): ?>
                                    <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr>
                                            <td class="p-3.5 font-bold text-gray-900"><?php echo e($item['name'] ?? '-'); ?></td>
                                            <td class="p-3.5 text-center font-bold"><?php echo e($qty); ?> pcs</td>
                                            <td class="p-3.5 text-right text-gray-600">Rp <?php echo e(number_format($price, 0, ',', '.')); ?></td>
                                            <td class="p-3.5 text-right font-black text-gray-900">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></td>
                                        </tr>
                ...
                <?php if($order->notes): ?>
                    <div class="p-4 bg-amber-50/50 rounded-2xl border border-amber-100">
                        ...
                        <div class="text-xs font-medium text-amber-900 mt-1 whitespace-pre-line"><?php echo e($order->notes); ?></div>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<head>
    ...
    <title>Detail Pesanan #<?php echo e($order->id); ?></title>
    ...
    <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-xs space-y-6">
        ...
        <div class="flex items-center justify-between p-4 rounded-2xl bg-gray-50 border border-gray-100">
            ...
            <div class="text-right">
                ...
                <div class="text-xl font-black text-gray-900 mt-0.5">Rp <?php echo e(number_format($order->total_price, 0, ',', '.')); ?></div>
            </div>
        </div>
        ...
        <div class="space-y-3 text-xs">
            <div class="flex justify-between py-2 border-b border-gray-50">
                ...
                <span class="font-bold text-gray-900"><?php echo e($order->customer_name ?: 'Pelanggan Online'); ?></span>
            </div>
            <div class="flex justify-between py-2 border-b border-gray-50">
                <span class="text-gray-400 font-bold">WhatsApp / Telepon</span>
                <?php if($order->customer_phone): ?>
                    <?php $phoneClean = preg_replace('/[^0-9]/', '', $order->customer_phone); ?>
                    <a href="https://wa.me/<?php echo e($phoneClean); ?>" target="_blank" class="font-bold text-emerald-600 hover:underline">
            ...
            <div class="flex justify-between py-2 border-b border-gray-50">
                ...
                <span class="font-bold text-gray-900"><?php echo e($order->created_at->format('d M Y, H:i')); ?> WIB</span>
            </div>
            <?php if($order->customer_address): ?>
                <div class="py-2 border-b border-gray-50">
                    <span class="text-gray-400 font-bold block mb-1">Alamat</span>
                    <span class="text-gray-700 font-medium whitespace-pre-line"><?php echo e($order->customer_address); ?></span>
                </div>
            <?php endif; ?>
            <?php if($order->notes): ?>
                <div class="py-2">
                    <span class="text-gray-400 font-bold block mb-1">Catatan</span>
                    <span class="text-amber-800 font-medium whitespace-pre-line"><?php echo e($order->notes); ?></span>
                </div>
            <?php endif; ?>
        </div>
                ...
                <?php if(is_array($order->items)): ?>
                    <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-3 bg-gray-50/50 flex justify-between items-center text-xs">
                            <div>
                                <div class="font-bold text-gray-900"><?php echo e($item['name'] ?? '-'); ?></div>
                                <div class="text-[11px] text-gray-400"><?php echo e($item['qty'] ?? 1); ?> pcs × Rp <?php echo e(number_format($item['price'] ?? 0, 0, ',', '.')); ?></div>
                            </div>
                            <div class="font-black text-gray-900">
                                Rp <?php echo e(number_format(($item['qty'] ?? 1) * ($item['price'] ?? 0), 0, ',', '.')); ?>
        ...
        <div class="pt-2 border-t border-gray-100 flex justify-end gap-2">
            <a href="<?php echo e(route('orders.edit', ['order' => $order->id, 'drawer' => 1])); ?>" class="px-5 py-2.5 bg-black hover:bg-[#D4AF37] text-white text-xs font-bold rounded-xl transition flex items-center gap-1.5">
...
<?php endif; ?>
<?php /**PATH C:\Users\Faiz\Perfu.me\resources\views/orders/show.blade.php ENDPATH**/ ?>