    ...
    <div x-data="{ 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white p-4 rounded-3xl shadow-xs border border-gray-100">
                <form action="<?php echo e(route('brands.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    <div class="md:col-span-9">
                        ...
                        <div class="relative">
                            ...
                            <input id="brand-search" type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama atau slug brand..."
                    ...
                    <div class="md:col-span-3 flex gap-2">
                        ...
                        <?php if(request('search')): ?>
                            <a href="<?php echo e(route('brands.index')); ?>" class="px-4 py-2.5 rounded-2xl bg-gray-100 text-xs font-bold text-gray-600 hover:bg-gray-200 transition text-center flex items-center justify-center">Reset</a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
                        ...
                        <tbody class="divide-y divide-gray-100 text-gray-700">
                            <?php $__empty_1 = true; $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50/70 transition-colors">
                                    <td class="py-4 px-6 text-center font-bold text-gray-400"><?php echo e($brands->firstItem() + $index); ?></td>
                                    ...
                                    <td class="py-4 px-6">
                                        <div class="font-bold text-gray-900 text-sm"><?php echo e($brand->name); ?></div>
                                        <?php if($brand->description): ?>
                                            <div class="text-xs text-gray-400 mt-0.5 truncate max-w-xs"><?php echo e($brand->description); ?></div>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td class="py-4 px-6 text-right">
                                        <div class="flex justify-end items-center gap-3">
                                            <button type="button" @click="openDrawer('<?php echo e(route('brands.show', ['brand' => $brand, 'drawer' => 1])); ?>', 'Detail Brand')"
                                            ...
                                            <button type="button" @click="openDrawer('<?php echo e(route('brands.edit', ['brand' => $brand, 'drawer' => 1])); ?>', 'Edit Brand')"
                                                title="Edit" class="text-[#b58d17] hover:text-[#8f6e12] transition-colors">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-[18px] w-[18px]" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125" />
                                                </svg>
                                            </button>
                                            <button type="button" @click="deleteModalOpen = true; deleteUrl = '<?php echo e(route('brands.destroy', $brand->id)); ?>'; brandName = '<?php echo e($brand->name); ?>'"
...
<?php endif; ?>
<?php /**PATH C:\Users\Faiz\Perfu.me\resources\views/brands/index.blade.php ENDPATH**/ ?>