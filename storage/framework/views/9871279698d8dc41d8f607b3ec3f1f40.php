<form action="<?php echo e(route('brands.update', $brand)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
    <?php echo csrf_field(); ?>
    ...
    <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-gray-100">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                ...
                <input type="text" name="name" class="w-full rounded-xl border-gray-300 focus:border-[#D4AF37] focus:ring focus:ring-[#D4AF37]/20 transition text-sm py-3 px-4 shadow-sm" value="<?php echo e(old('name', $brand->name)); ?>" required>
            ...
            <div>
                ...
                <?php if($brand->logo): ?>
                    <div class="flex items-center gap-4 mb-3 p-3 bg-gray-50 rounded-xl border border-gray-200">
                        <img src="<?php echo e(asset('storage/' . $brand->logo)); ?>" alt="<?php echo e($brand->name); ?>" class="w-12 h-12 object-cover rounded-lg">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-gray-100">
        ...
        <div>
            ...
            <textarea name="description" rows="4" class="w-full rounded-xl border-gray-300 focus:border-[#D4AF37] focus:ring focus:ring-[#D4AF37]/20 transition text-sm p-4 shadow-sm"><?php echo e(old('description', $brand->description)); ?></textarea>
...
<?php /**PATH C:\Users\Faiz\Perfu.me\resources\views\brands\form-edit.blade.php ENDPATH**/ ?>