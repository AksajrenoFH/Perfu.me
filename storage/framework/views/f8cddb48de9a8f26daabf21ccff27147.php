...
<?php $component->withAttributes([]); ?>
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-extrabold text-black tracking-tight">
                        Edit <span class="text-[#D4AF37]">Pesanan #<?php echo e($order->id); ?></span>
                    </h2>
            ...
            <form method="POST" action="<?php echo e(route('orders.update', $order)); ?>" class="bg-white border border-gray-100 rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
                <?php echo csrf_field(); ?>
...
<head>
    ...
    <title>Edit Pesanan #<?php echo e($order->id); ?></title>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js']); ?>
</head>
<body class="bg-[#F8F9FA] p-6 antialiased">
    <form method="POST" action="<?php echo e(route('orders.update', ['order' => $order->id, 'drawer' => 1])); ?>" class="bg-white border border-gray-100 rounded-3xl p-6 shadow-xs space-y-6">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        <?php echo $__env->make('orders._form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
...
<?php endif; ?>
<?php /**PATH C:\Users\Faiz\Perfu.me\resources\views/orders/edit.blade.php ENDPATH**/ ?>