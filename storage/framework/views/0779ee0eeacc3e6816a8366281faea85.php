        ...
        <div class="max-w-[1240px] mx-auto px-6 sm:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-1.5 text-xs text-neutral-400">
                    <li><a href="<?php echo e(route('home')); ?>#product" class="hover:text-white transition">Dynamyst Extrait</a></li>
                    <li><a href="<?php echo e(route('home')); ?>#product" class="hover:text-white transition">Vanessence Extrait</a></li>
...
</html><?php /**PATH C:\Users\Ghani\kelompok parfum\Perfu.me\resources\views/customer/refillpage.blade.php ENDPATH**/ ?>