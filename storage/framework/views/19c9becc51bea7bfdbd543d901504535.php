...
<div class="<?php echo e(request('drawer') ? 'py-6' : 'py-12'); ?> bg-[#F8F9FA] min-h-screen">
    <div class="<?php echo e(request('drawer') ? 'max-w-full' : 'max-w-4xl'); ?> mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="<?php echo e(route('products.store', request('drawer') ? ['drawer' => 1] : [])); ?>" method="POST"
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <small class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></small>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="category"
                            ...
                            <option value="Original" <?php echo e(old('category') == 'Original' ? 'selected' : ''); ?>>
                                Produk Original (Signature)
                            </option>
                            <option value="Refill" <?php echo e(old('category') == 'Refill' ? 'selected' : ''); ?>>
                                Parfum Refill
                            </option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="variant"
                            ...
                            <option value="EDP" <?php echo e(old('variant') == 'EDP' ? 'selected' : ''); ?>>
                                EDP (Eau de Parfum)
                            </option>
                            <option value="EDT" <?php echo e(old('variant') == 'EDT' ? 'selected' : ''); ?>>
                                EDT (Eau de Toilette)
                            </option>
                            <option value="Roll-on" <?php echo e(old('variant') == 'Roll-on' ? 'selected' : ''); ?>>
                                Roll-on
                            </option>
                            <option value="Body Mist" <?php echo e(old('variant') == 'Body Mist' ? 'selected' : ''); ?>>
                                Body Mist
                            </option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="gender"
                            ...
                            <option value="Pria" <?php echo e(old('gender') == 'Pria' ? 'selected' : ''); ?>>
                                Pria (Masculine)
                            </option>
                            <option value="Wanita" <?php echo e(old('gender') == 'Wanita' ? 'selected' : ''); ?>>
                                Wanita (Feminine)
                            </option>
                            <option value="Unisex" <?php echo e(old('gender') == 'Unisex' ? 'selected' : ''); ?>>
                                Unisex (Keduanya)
                            </option>
                        </select>
                    </div>
            ...
            <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="top_note" value="<?php echo e(old('top_note')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="middle_note" value="<?php echo e(old('middle_note')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="base_note" value="<?php echo e(old('base_note')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="composition" rows="3" placeholder="Contoh: Alcohol, fragrance, aqua..."
                            class="w-full rounded-xl border-gray-300 focus:border-[#D4AF37] focus:ring focus:ring-[#D4AF37]/20 transition text-sm p-4 shadow-sm"><?php echo e(old('composition')); ?></textarea>
            ...
            <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="packaging" value="<?php echo e(old('packaging')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            <?php $__currentLoopData = ['5', '15', '30', '50', '60', '100', '120']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $checked = collect(old('volume', []))->contains($vol); ?>
                                <label class="flex items-center gap-2 border border-gray-300 rounded-xl px-4 py-2.5 text-sm cursor-pointer has-[:checked]:border-[#D4AF37] has-[:checked]:bg-[#D4AF37]/10 transition">
                                    <input type="checkbox" name="volume[]" value="<?php echo e($vol); ?>"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="price" value="<?php echo e(old('price')); ?>" placeholder="45000"
                                min="0" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="stock" value="<?php echo e(old('stock', 100)); ?>" min="0"
                            placeholder="100"
                            class="w-full rounded-xl border-gray-300 focus:border-[#D4AF37] focus:ring focus:ring-[#D4AF37]/20 transition text-sm py-3 px-4 shadow-sm">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="5"
                            ...
                            class="w-full rounded-xl border-gray-300 focus:border-[#D4AF37] focus:ring focus:ring-[#D4AF37]/20 transition text-sm p-4 shadow-sm"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center pt-2">
                        <input type="checkbox" id="is_best_seller" name="is_best_seller" value="1"
                            <?php echo e(old('is_best_seller') ? 'checked' : ''); ?>
...
</div><?php /**PATH C:\Users\Ghani\kelompok parfum\Perfu.me\resources\views/products/form-create.blade.php ENDPATH**/ ?>