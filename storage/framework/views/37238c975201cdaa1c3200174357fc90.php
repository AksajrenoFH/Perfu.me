            ...
            <div class="bg-white p-4 rounded-3xl shadow-xs border border-gray-100">
                <form action="<?php echo e(route('products.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    ...
                    <div class="md:col-span-5">
                        ...
                        <input id="product-search" type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama parfum..." class="w-full rounded-2xl border-gray-200 bg-gray-50/80 py-2.5 text-xs font-medium focus:border-[#D4AF37] focus:ring-[#D4AF37]/20">
                    </div>
                    <div class="md:col-span-3 flex gap-2">
                        ...
                        <?php if(request('type') || request('search')): ?>
                            <a href="<?php echo e(route('products.index')); ?>" class="px-4 py-2.5 rounded-2xl bg-gray-100 text-xs font-bold text-gray-600 hover:bg-gray-200 transition">Reset</a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
                        ...
                        <tbody class="divide-y divide-gray-50 text-xs font-medium text-gray-600">
                            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50/60 transition-colors group">
                                    <td class="py-4 px-6 text-center font-bold text-gray-400 group-hover:text-black transition-colors"><?php echo e($products->firstItem() + $index); ?></td>
                                    ...
                                    <td class="py-4 px-6">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div class="font-bold text-gray-900 text-sm tracking-tight"><?php echo e($product->name); ?></div>
                                                <div class="text-[11px] text-gray-400 mt-0.5">Gender: <span class="text-gray-700 font-semibold"><?php echo e($product->gender ?: 'Universal'); ?></span></div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="py-4 px-6">
                                        ...
                                        <?php else: ?>
                                            <span class="px-2.5 py-1 rounded-lg text-[11px] font-semibold bg-gray-100 text-gray-600"><?php echo e($product->category ?: '-'); ?></span>
                                        <?php endif; ?>
                                    </td>

                                    <td class="py-4 px-6">
                                        <span class="px-2.5 py-1 rounded-lg text-[11px] font-semibold bg-gray-100 text-gray-600"><?php echo e($product->variant ?: '-'); ?></span>
                                    </td>
                                    ...
                                    <td class="py-4 px-6 text-center">
                                        <span class="inline-block px-3 py-1 rounded-xl font-bold text-xs <?php echo e($product->stock < 10 ? 'bg-red-50 text-red-600 border border-red-100' : 'bg-green-100/80 text-green-800'); ?>">
                                    ...
                                    <td class="py-4 px-6 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <button @click="deleteModalOpen = true; deleteUrl = '<?php echo e(route('products.destroy', $product->id)); ?>'; productName = '<?php echo e($product->name); ?>'" type="button"
...
<?php endif; ?><?php /**PATH C:\Users\Ghani\kelompok parfum\Perfu.me\resources\views/products/index.blade.php ENDPATH**/ ?>