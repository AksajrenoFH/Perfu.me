    ...
    <div x-data="{ 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white p-4 rounded-3xl shadow-xs border border-gray-100">
                <form action="<?php echo e(route('orders.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    ...
                    <div class="md:col-span-5">
                        ...
                        <div class="relative">
                            ...
                            <input id="order-search" type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari ID, nama pembeli, atau nomor WhatsApp..."
                    ...
                    <div class="md:col-span-3 flex gap-2">
                        ...
                        <?php if(request('status') || request('search')): ?>
                            <a href="<?php echo e(route('orders.index')); ?>" class="px-4 py-2.5 rounded-2xl bg-gray-100 text-xs font-bold text-gray-600 hover:bg-gray-200 transition text-center flex items-center justify-center">Reset</a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="hover:bg-gray-50/70 transition-colors">
                                    ...
                                    <td class="py-4 px-6 text-xs text-gray-600">
                                        <div class="font-bold text-gray-900"><?php echo e($itemsCount); ?> pcs total</div>
                                    ...
                                    <td class="py-4 px-6 text-right">
                                        <div class="flex justify-end items-center gap-3">
                                            ...
                                            <button type="button" @click="deleteModalOpen = true; deleteUrl = '<?php echo e(route('orders.destroy', $order)); ?>'; orderNumber = '#<?php echo e($order->id); ?>'"
...
<?php endif; ?><?php /**PATH C:\Users\Ghani\kelompok parfum\Perfu.me\resources\views/orders/index.blade.php ENDPATH**/ ?>