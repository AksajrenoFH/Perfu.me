...
<head>
    ...
    <style>
        ...
        /*
         * Area carousel dibuat sedikit masuk dari kiri/kanan agar selalu
         * ada jarak +/- 20px dari viewport.
         */
        #lineup-carousel .lineup-stage {
            position: relative;
            width: calc(100% - 40px);
            margin-inline: 20px;
        ...
        #lineup-carousel .lineup-stage.is-dragging {
            cursor: grabbing;
        }
        ...
        #lineup-carousel .lineup-stage.is-dragging .lineup-card {
            cursor: grabbing;
        ...
        #lineup-carousel .lineup-controls {
            position: relative;
            z-index: 200;
        }

        #lineup-carousel .lineup-arrow {
            width: 42px;
            height: 42px;
        ...
        #lineup-carousel .lineup-arrow:hover {
            transform: scale(1.05);
            background: rgba(255, 255, 255, .10);
            border-color: rgba(255, 255, 255, .55);
        }

        #lineup-carousel .lineup-arrow:active {
            transform: scale(.94);
        }
...
<body class="text-neutral-900 antialiased bg-white selection:bg-neutral-900 selection:text-white"
    ...
    <section id="hero-section" class="relative overflow-hidden border-b border-neutral-100" style="min-height: 88vh;"
        ...
        <div class="hidden lg:block absolute inset-y-0 left-0 w-[48%] overflow-hidden">
            ...
            <div class="absolute inset-y-0 right-0 w-28 bg-gradient-to-l from-white to-transparent pointer-events-none">
            </div>
            <div
                class="absolute top-8 left-8 glass-panel border border-white/60 shadow-lg rounded-2xl px-4 py-3 space-y-0.5">
            ...
            <div
                class="absolute bottom-10 left-8 glass-panel border border-white/60 shadow-lg rounded-2xl px-4 py-3 space-y-0.5">
        ...
        <div
            ...
            <div
                class="lg:hidden relative aspect-[4/3] rounded-2xl overflow-hidden border border-neutral-200 shadow-md">
            ...
            <div class="space-y-4 max-w-lg">
                <div
                    class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-100 border border-neutral-200 text-[10px] font-bold text-neutral-600 tracking-widest uppercase">
                    <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
                    <span>HAUTE PARFUMERIE · EXTRAIT 2025</span>
                </div>

                <h1
                    class="text-3xl sm:text-4xl xl:text-[44px] font-extrabold tracking-tight text-neutral-950 leading-[1.12]">
                    Aura yang<br>
                ...
                <p class="text-[13px] sm:text-sm text-neutral-500 leading-relaxed max-w-sm">
                    Perfu.me menghadirkan konsentrasi <strong class="text-neutral-800 font-semibold">Extrait de Parfum
                        murni</strong> yang diformulasikan untuk proyeksi aroma lembut dengan ketahanan seharian.
                </p>
            </div>

            <div id="scent-switcher" class="space-y-2 max-w-lg">
                <p class="text-[10px] font-bold tracking-widest text-neutral-400 uppercase mb-3">Pilih Aroma Signature
                </p>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    ...
                                    x-text="scent.tag"></span>
                            </div>
                            <p class="text-[11px] mt-0.5 truncate opacity-70" x-text="scent.character"></p>
                            <p class="text-[10px] mt-0.5 truncate opacity-60 font-semibold"
                                x-text="'Ukuran: ' + scent.volume"></p>
                        </div>
            ...
            <template x-for="(scent, index) in scents" :key="'notes-' + index">
                <div x-show="activeScent === index" x-transition:enter="transition ease-out duration-200"
                    ...
                    <div class="bg-neutral-50 border border-neutral-200/80 rounded-xl p-3">
                        ...
                        <p class="text-[11px] font-semibold text-neutral-900 leading-snug" x-text="scent.heartNotes">
                        </p>
                    </div>
                    <div class="bg-neutral-50 border border-neutral-200/80 rounded-xl p-3">
                    ...
                    <div class="bg-neutral-50 border border-neutral-200/80 rounded-xl p-3">
                        ...
                        <p class="text-[11px] font-semibold text-neutral-900 leading-snug" x-text="scent.volume"></p>
                    </div>
                </div>
            </template>
    ...
    image: scent.image
                        ...
                        <button @click="directCheckoutWhatsApp(scent.name + ' Extrait 50ml', scent.price)"
            ...
            <div class="flex items-center gap-3 pt-1 max-w-lg border-t border-neutral-100">
                <div class="flex -space-x-2 overflow-hidden pt-3">
                    <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80"
                        alt="Minjeong" class="inline-block h-7 w-7 rounded-full ring-2 ring-white object-cover">
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&auto=format&fit=crop&q=80"
                        alt="Reza" class="inline-block h-7 w-7 rounded-full ring-2 ring-white object-cover">
                    <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&auto=format&fit=crop&q=80"
                        alt="Amanda" class="inline-block h-7 w-7 rounded-full ring-2 ring-white object-cover">
                    <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&auto=format&fit=crop&q=80"
                        alt="Kevin" class="inline-block h-7 w-7 rounded-full ring-2 ring-white object-cover">
                </div>
                <div class="pt-3">
                    <div class="flex items-center gap-1 text-amber-500 text-[11px]">
                        <span>★★★★★</span>
                        <span
                            class="font-bold text-neutral-950 ml-0.5"><?php echo e(number_format($avgRating ?? 5.0, 1)); ?></span>
        ...
        <div x-ref="stage" class="lineup-stage" @pointerdown="startDrag($event)"
            ...
            <template x-for="card in displayItems" :key="card.key">
                <a :href="card.item.url" :style="cardStyle(card.index)"
                    ...
                    @click="handleClick($event, card.index)" draggable="false"
                    class="lineup-card rounded-2xl overflow-hidden bg-white text-neutral-900 border border-neutral-300 shadow-2xl block">
                    ...
                    <div class="h-[28%] bg-neutral-950 text-white px-4 py-3 flex flex-col justify-center">
                        <p class="text-xs sm:text-sm font-bold leading-snug truncate" x-text="card.item.name"></p>
                        <p class="text-[10px] text-neutral-400 mt-1 truncate"
                            x-text="card.item.subtitle + ' · ' + card.item.volume"></p>
                        <p class="text-[11px] font-bold text-white mt-2" x-text="card.item.price"></p>
                    </div>
                </a>
            </template>
        </div>

        <div class="lineup-controls flex items-center justify-center gap-6 mt-5">
            <button type="button" @click="prev()" class="lineup-arrow" aria-label="Previous perfume">
            ...
            <button type="button" @click="next()" class="lineup-arrow" aria-label="Next perfume">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
    ...
    <section id="usp-section" class="max-w-[1240px] mx-auto px-6 sm:px-8 py-12 border-b border-neutral-100">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div
                class="flex items-start gap-3.5 p-5 rounded-2xl bg-neutral-50/70 border border-neutral-200/70 card-hover">
                <div
                    class="w-10 h-10 rounded-xl bg-white border border-neutral-200/80 shadow-2xs flex items-center justify-center shrink-0 text-neutral-900">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-neutral-900" fill="none"
                ...
                <div>
                    ...
                    <p class="text-[11px] text-neutral-500 mt-0.5 leading-relaxed">Diracik dengan rasio konsentrasi
                        bibit wangi murni tertinggi tanpa alkohol menyengat.</p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
            ...
            <div class="lg:col-span-6 space-y-5">
                ...
                <p class="text-neutral-500 leading-relaxed text-sm sm:text-[15px]">
                    Kami percaya bahwa wangi bukan sekadar aroma pendukung penampilan, melainkan pernyataan karakter dan
                    rasa percaya diri. Setiap botol di <strong class="text-neutral-900 font-semibold">Perfu.me</strong>
                    melalui proses kurasi presisi untuk memastikan harmoni antara kemewahan dan fungsionalitas pemakaian
                    sehari-hari.
                </p>
                ...
                <div class="space-y-3 pt-1">
                    <div class="flex items-center gap-3 text-xs sm:text-sm font-medium text-neutral-800">
                        <span
                            class="w-5 h-5 bg-neutral-950 text-white rounded-full flex items-center justify-center text-[10px] shrink-0">✓</span>
    ...
    <section id="product" class="max-w-[1240px] mx-auto px-6 sm:px-8 py-16 bg-white border-t border-neutral-100">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
                    ...
                    <div
                        ...
                        <?php if($ori->image_hover): ?>
                            <img src="<?php echo e(asset('storage/' . $ori->image_hover)); ?>"
                    ...
                    <div class="lg:py-4 space-y-6 <?php echo e($isEven ? 'lg:order-1' : 'lg:order-2'); ?>">
                        ...
                        <div class="grid grid-cols-4 gap-3 bg-neutral-50 p-4 rounded-xl border border-neutral-200/80">
                            <div>
                                ...
                                <p class="text-[11px] font-bold text-neutral-900 leading-snug"><?php echo e($ori->top_note); ?>

                                </p>
                            </div>
                            <div>
                                <p class="text-[9px] tracking-widest text-neutral-400 font-bold mb-1">MIDDLE NOTES</p>
                                <p class="text-[11px] font-bold text-neutral-900 leading-snug"><?php echo e($ori->middle_note); ?>

                                </p>
                            </div>
                            <div>
                                <p class="text-[9px] tracking-widest text-neutral-400 font-bold mb-1">BASE NOTES</p>
                                <p class="text-[11px] font-bold text-neutral-900 leading-snug"><?php echo e($ori->base_note); ?>
                        ...
                        <div class="flex flex-col sm:flex-row gap-2.5">
                            <button
                                @click="addToCart({
        product_id: <?php echo \Illuminate\Support\Js::from($ori->id)->toHtml() ?>,
        ...
        <?php echo \Illuminate\Support\Js::from($ori->id)->toHtml() ?>,
    ...
    <section id="reviews" class="bg-neutral-50/70 py-16 lg:py-24 border-t border-b border-neutral-200/70">
        <div class="max-w-[1240px] mx-auto px-6 sm:px-8">
            <div class="text-center max-w-lg mx-auto mb-14 space-y-2">
                ...
                <p class="text-neutral-500 text-xs sm:text-sm">Pendapat jujur dari mereka yang telah merasakan kualitas
                    Extrait de Parfum kami.</p>
            </div>
                    ...
                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            ...
                            <div class="flex items-center gap-3 pt-3 border-t border-neutral-100">
                                ...
                                <div>
                                    <h4 class="text-xs font-bold text-neutral-900 capitalize"><?php echo e($review->user_name); ?>

                                    </h4>
                                    <p class="text-[10px] text-neutral-400">
                                        <?php echo e($review->product->name ?? 'Pelanggan Perfu.me'); ?>
                ...
                <?php else: ?>
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-xs text-neutral-600 leading-relaxed mb-5">"Wanginya tahan seharian di kantor
                                ber-AC. Tipe wangi yang nggak bikin pusing tapi ninggalin kesan mewah pas salaman sama
                                klien."</p>
                        </div>
                        <div class="flex items-center gap-3 pt-3 border-t border-neutral-100">
                            <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=120&auto=format&fit=crop&q=80"
                                alt="Reza Darmawan"
                                class="w-9 h-9 rounded-full object-cover border border-neutral-200 shadow-xs">
                            <div>
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3 pt-3 border-t border-neutral-100">
                            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=120&auto=format&fit=crop&q=80"
                                alt="Amanda Nadia"
                                class="w-9 h-9 rounded-full object-cover border border-neutral-200 shadow-xs">
                            <div>
    ...
    <template x-if="tourOpen">
        <div class="fixed inset-0 z-[999]">
            ...
            <div class="fixed z-[1000] bg-white rounded-2xl shadow-2xl border border-neutral-200 p-5 space-y-3.5 transition-all duration-300 ease-out"
                ...
                <div class="flex items-center justify-between">
                    <span class="text-[10px] font-bold tracking-widest text-neutral-400 uppercase"
                ...
                <div class="flex items-center justify-between pt-2 border-t border-neutral-100">
                    <button @click="closeTour()"
                        class="text-[11px] font-semibold text-neutral-400 hover:text-neutral-700 transition cursor-pointer">
                        Lewati
                    </button>
                        ...
                        <div class="flex-1 overflow-y-auto px-6 py-4 space-y-3">
                            <template x-if="items.length === 0">
                                <div class="text-center py-20 text-neutral-400 space-y-2.5">
                                    ...
                                    <a href="#product" @click="cartOpen = false"
    ...
    <script>
        /**
         * Lineup Coverflow Carousel — TRUE INFINITE LOOP VERSION
         *
         * currentIndex adalah index VIRTUAL, boleh naik/turun tanpa
         * batas. Item asli yang ditampilkan diambil via modulo dari
         * array products. Dengan begini tidak perlu lagi trik
         * "duplikat 9 copy array + recenter manual" yang rawan drift
         * dan bikin carousel keliatan "reset" ke awal saat di-drag
         * atau diklik cepat berkali-kali.
         */
        function productCarousel(products) {
            return {
                ...
                /* ==================================================
                   INFINITE DISPLAY (virtual index + modulo)
                ================================================== */
                displayItems: [],
                currentIndex: 0,

                /* Jumlah card yang masih boleh terlihat di kiri/kanan */
                visibleSideCount: 4,

                /* Jarak pusat antar card (dibuat > lebar card supaya ADA GAP) */
                step: 285,
                ...
                init() {
                    ...
                    if (this.products.length) {
                        this.currentIndex = Math.floor((this.products.length - 1) / 2);
                    }
                ...
                /* ==================================================
                   RESPONSIVE LAYOUT
                   step dibuat lebih besar dari lebar card (lihat CSS
                   .lineup-card) supaya antar gambar ada jarak/gap
                   yang jelas, tidak saling dempet/tumpuk.
                ================================================== */
                setLayout() {
                    ...
                    if (width < 640) {
                        /* card 200px */
                        this.step = 210;
                        this.visibleSideCount = 3;
                    } else if (width < 1024) {
                        /* card 230px */
                        this.step = 245;
                        this.visibleSideCount = 4;
                    } else {
                        /* card 260px */
                        this.step = 285;
                        this.visibleSideCount = 4;
                ...
                /* ==================================================
                   BUILD CARD DI SEKITAR currentIndex SAJA

                   realIndex = posisi absolut, boleh negatif/positif,
                   TIDAK PERNAH di-wrap. itemIndex = realIndex yang
                   dipetakan (mod) ke data produk asli. Karena key
                   memakai realIndex, saat currentIndex bergeser 1,
                   sebagian besar card tetap sama (DOM node tidak
                   dibuat ulang) sehingga transisi tetap mulus — dan
                   karena tidak ada batas array, looping jadi benar2
                   tanpa akhir tanpa perlu "recenter" / snap.
                ================================================== */
                buildDisplayItems() {
                    ...
                    const range = this.visibleSideCount + 1; // buffer ekstra utk fade-in halus
                    const items = [];

                    for (let offset = -range; offset <= range; offset++) {
                        const realIndex = this.currentIndex + offset;
                        const itemIndex = ((realIndex % count) + count) % count;

                        items.push({
                            key: 'pos-' + realIndex,
                            index: realIndex,
                            item: this.products[itemIndex],
                            offset,
                        });
                    }
                ...
                /* ==================================================
                   CARD POSITION / COVERFLOW
                ================================================== */
                cardStyle(index) {
                    const offset = index - this.currentIndex;
                    const distance = Math.abs(offset);

                    const x = (offset * this.step) + this.dragOffset;

                    /*
                     * Skala bertingkat lebih halus (ala Velixir) — card
                     * samping tidak terlalu mengecil, jadi tetap jelas
                     * terlihat dan proporsinya lebih "penuh" seperti
                     * referensi.
                     */
                    const scaleSteps = [
                        1.00,
                    ...
                    const scale =
                        scaleSteps[Math.min(distance, scaleSteps.length - 1)];
                     ...
                     * tinggi, card samping sedikit lebih rendah. Nilainya
                     * dibuat kecil (maks ±30px) dan DIGABUNG dengan -50%
                     * (lihat transform di bawah) supaya card selalu
                     * benar-benar center secara vertikal dan tidak akan
                    ...
                    /* Saat drag benar-benar disable transition */
                    ...
                    return `
                        ...
                        opacity:${opacity};
                        z-index:${zIndex};
                        pointer-events:${distance <= this.visibleSideCount ? 'auto' : 'none'};
                        transform:translate(calc(-50% + ${x}px), calc(-50% + ${floatOffset}px)) scale(${scale});
                        transition:transform ${duration}ms cubic-bezier(.22,1,.36,1), opacity ${duration}ms ease;
                    `;
                },
                ...
                endDrag(e) {
                    ...
                    if (Math.abs(dx) >= threshold) {
                        const movement = Math.max(
                            1,
                            Math.min(3, Math.round(Math.abs(dx) / this.step))
                        );

                        /*
                         * Tarik ke kiri  -> next
                         * Tarik ke kanan -> previous
                         */
                        if (dx < 0) {
                    ...
                    /* Kembalikan drag offset ke nol dan bangun ulang
                       daftar card di sekitar currentIndex terbaru. */
                    this.dragOffset = 0;
                    this.buildDisplayItems();
                },
                ...
                handleClick(e, index) {
                    ...
                    /*
                     * Card samping ketika diklik dibawa ke tengah.
                     * Card tengah tetap membuka link.
                     */
                ...
                /* ==================================================
                   GO TO CARD (index absolut, bukan modulo)
                ================================================== */
                goTo(index) {
                ...
                async saveOrder(items) {
                    try {
                        const response = await fetch(
                            '<?php echo e(route('orders.checkout')); ?>', {
                                method: 'POST',
...
</html><?php /**PATH C:\Users\USER\Perfu.me\resources\views/customer/home.blade.php ENDPATH**/ ?>