<div class="<?php echo e(request('drawer') ? 'py-6' : 'py-12'); ?> bg-[#F8F9FA] min-h-screen" x-data="{ rating: '<?php echo e(old('rating', '5')); ?>', tempRating: null }">
    ...
    <div class="<?php echo e(request('drawer') ? 'max-w-full' : 'max-w-4xl'); ?> mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="<?php echo e(route('reviews.store', request('drawer') ? ['drawer' => 1] : [])); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="user_name"
                            class="w-full rounded-xl border-gray-300 focus:border-[#D4AF37] focus:ring focus:ring-[#D4AF37]/20 transition text-sm py-3 px-4 shadow-sm font-medium"
                            value="<?php echo e(old('user_name')); ?>" placeholder="Contoh: Budi Santoso" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="comment" rows="4"
                            ...
                            placeholder="Tuliskan ulasan detail mengenai ketahanan, aroma, atau pelayanan..." required><?php echo e(old('comment')); ?></textarea>
...
<?php /**PATH C:\Users\Faiz\Perfu.me\resources\views\reviews\form-create.blade.php ENDPATH**/ ?>