<!-- Sidebar Navigation -->
<div x-data="{ 
        openDropdown: <?php echo e(request()->routeIs('products.*') ? 'true' : 'false'); ?>,
        userMenuOpen: false
     }" class="contents">
...
<div class="relative flex items-center justify-center h-16 sm:h-20 px-6 border-b border-gray-50 shrink-0 overflow-hidden">
    <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2 transition-transform duration-300 group">
        <!-- Logo Full -->
        ...
        <div class="flex-1 py-6 space-y-1.5 overflow-y-auto overflow-x-hidden custom-scrollbar" :class="isCollapsed ? 'px-2' : 'px-4'">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" 
               ...
               :class="isCollapsed ? 'justify-center px-0' : 'px-3.5'">
                ...
                <svg class="w-5 h-5 flex-shrink-0 transition-colors <?php echo e(request()->routeIs('dashboard') ? 'text-[#D4AF37]' : 'text-gray-400 group-hover:text-[#D4AF37]'); ?>" :class="isCollapsed ? 'mr-0' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('orders.index')); ?>" 
               ...
               class="group relative flex items-center py-3 text-sm font-medium rounded-2xl transition-all duration-200
               <?php echo e(request()->routeIs('orders.*') 
                  ? 'bg-black text-white shadow-md shadow-black/10' 
                  : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>"
               :class="isCollapsed ? 'justify-center px-0' : 'px-3.5'">
                ...
                <svg class="w-5 h-5 flex-shrink-0 transition-colors <?php echo e(request()->routeIs('orders.*') ? 'text-[#D4AF37]' : 'text-gray-400 group-hover:text-[#D4AF37]'); ?>" :class="isCollapsed ? 'mr-0' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-1">
                <div class="group relative flex items-center justify-between py-3 text-sm font-medium rounded-2xl transition-all duration-200
                    ...
                    <a href="<?php echo e(route('products.index')); ?>" title="Katalog Produk" class="flex items-center flex-1 min-w-0" :class="isCollapsed ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0 transition-colors <?php echo e(request()->routeIs('products.*') ? 'text-[#D4AF37]' : 'text-gray-400 group-hover:text-[#D4AF37]'); ?>" :class="isCollapsed ? 'mr-0' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-show="openDropdown && !isCollapsed" x-transition.origin.top.duration.200ms class="pl-9 pr-1 space-y-1 pt-1" style="display: none;">
                    <a href="<?php echo e(route('products.index')); ?>" class="block px-3 py-1.5 text-xs rounded-xl transition-colors <?php echo e(!request('type') && request()->routeIs('products.index') ? 'text-[#D4AF37] bg-gray-100 font-medium' : 'text-gray-500 hover:text-black hover:bg-gray-50'); ?>">
                        Semua Produk
                    </a>
                    <a href="<?php echo e(route('products.index', ['type' => 'Original'])); ?>" class="block px-3 py-1.5 text-xs rounded-xl transition-colors <?php echo e(request('type') == 'Original' ? 'text-[#D4AF37] bg-gray-100 font-medium' : 'text-gray-500 hover:text-black hover:bg-gray-50'); ?>">
                        Produk Original
                    </a>
                    <a href="<?php echo e(route('products.index', ['type' => 'Refill'])); ?>" class="block px-3 py-1.5 text-xs rounded-xl transition-colors <?php echo e(request('type') == 'Refill' ? 'text-[#D4AF37] bg-gray-100 font-medium' : 'text-gray-500 hover:text-black hover:bg-gray-50'); ?>">
                        Parfum Refill
                    </a>
                </div>
            </div>
            ...
            <a href="<?php echo e(route('brands.index')); ?>" 
               ...
               :class="isCollapsed ? 'justify-center px-0' : 'px-3.5'">
                ...
                <svg class="w-5 h-5 flex-shrink-0 transition-colors <?php echo e(request()->routeIs('brands.*') ? 'text-[#D4AF37]' : 'text-gray-400 group-hover:text-[#D4AF37]'); ?>" :class="isCollapsed ? 'mr-0' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('reviews.index')); ?>" 
               ...
               :class="isCollapsed ? 'justify-center px-0' : 'px-3.5'">
                ...
                <svg class="w-5 h-5 flex-shrink-0 transition-colors <?php echo e(request()->routeIs('reviews.*') ? 'text-[#D4AF37]' : 'text-gray-400 group-hover:text-[#D4AF37]'); ?>" :class="isCollapsed ? 'mr-0' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative">
                ...
                <button @click="userMenuOpen = !userMenuOpen" 
                    ...
                    <div x-show="!isCollapsed" class="flex-1 min-w-0 ml-3 truncate">
                        <div class="font-medium text-xs text-gray-900 truncate"><?php echo e(Auth::user()->name); ?></div>
                ...
                <div x-show="userMenuOpen" 
                    ...
                    <div class="px-3 py-2.5">
                        <p class="text-xs font-medium text-gray-900"><?php echo e(Auth::user()->name); ?></p>
                        <p class="text-[11px] text-gray-400 truncate"><?php echo e(Auth::user()->email); ?></p>
                    </div>

                    <div class="py-1 space-y-0.5">
                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-2 px-3 py-2 text-xs text-gray-700 hover:bg-gray-50 hover:text-black rounded-xl transition">
                        ...
                        <a href="<?php echo e(route('home')); ?>" target="_blank" class="flex items-center gap-2 px-3 py-2 text-xs text-gray-700 hover:bg-gray-50 hover:text-black rounded-xl transition">
...
<?php /**PATH C:\Users\Ghani\kelompok parfum\Perfu.me\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>