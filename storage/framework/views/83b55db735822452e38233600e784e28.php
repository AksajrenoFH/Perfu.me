        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    ...
                    <span class="font-bold text-gray-800"><?php echo e($product->name); ?></span>.
                </p>
            </div>
        </div>

        <form action="<?php echo e(route('products.update', $product->id)); ?>" method="POST" enctype="multipart/form-data"
            class="space-y-6" target="<?php echo e(request('drawer') ? '_parent' : '_self'); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="variant"
                            ...
                            <option value="EDP" <?php echo e(old('variant', $product->variant) == 'EDP' ? 'selected' : ''); ?>>
                                EDP (Eau de Parfum)</option>
                            <option value="EDT" <?php echo e(old('variant', $product->variant) == 'EDT' ? 'selected' : ''); ?>>
                                EDT (Eau de Toilette)</option>
                            <option value="Roll-on"
                                <?php echo e(old('variant', $product->variant) == 'Roll-on' ? 'selected' : ''); ?>>Roll-on</option>
                            <option value="Body Mist"
                                <?php echo e(old('variant', $product->variant) == 'Body Mist' ? 'selected' : ''); ?>>Body Mist
                            </option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="gender"
                            ...
                            <option value="Pria" <?php echo e(old('gender', $product->gender) == 'Pria' ? 'selected' : ''); ?>>
                                Pria (Masculine)</option>
                            <option value="Wanita" <?php echo e(old('gender', $product->gender) == 'Wanita' ? 'selected' : ''); ?>>
                                Wanita (Feminine)</option>
                            <option value="Unisex" <?php echo e(old('gender', $product->gender) == 'Unisex' ? 'selected' : ''); ?>>
            ...
            <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="top_note" value="<?php echo e(old('top_note', $product->top_note)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="base_note" value="<?php echo e(old('base_note', $product->base_note)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="composition" rows="3" placeholder="Contoh: Alcohol, fragrance, aqua..."
                            class="w-full rounded-xl border-gray-300 focus:border-[#D4AF37] focus:ring focus:ring-[#D4AF37]/20 transition text-sm p-4 shadow-sm"><?php echo e(old('composition', $product->composition)); ?></textarea>
            ...
            <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="packaging" value="<?php echo e(old('packaging', $product->packaging)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="volume" value="<?php echo e(old('volume', $product->volume)); ?>"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="5"
                            class="w-full rounded-xl border-gray-300 focus:border-[#D4AF37] focus:ring focus:ring-[#D4AF37]/20 transition text-sm p-4 shadow-sm"><?php echo e(old('description', $product->description)); ?></textarea>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <?php if($product->image_hover): ?>
                                <div class="flex items-center gap-3 bg-gray-50 p-3 rounded-2xl border border-gray-200">
                                    <img src="<?php echo e(asset('storage/' . $product->image_hover)); ?>"
...
<?php /**PATH C:\Users\USER\Perfu.me\resources\views/products/form-edit.blade.php ENDPATH**/ ?>