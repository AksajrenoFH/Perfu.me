        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div class="bg-white p-6 rounded-3xl border border-gray-100 flex items-center justify-between">
                    <div class="space-y-1.5">
                        ...
                        <div class="text-xs text-gray-500 flex items-center gap-1.5">
                            ...
                            <?php echo e($completedOrdersCount); ?> pesanan lunas
                        </div>
                    </div>
                ...
                <div class="bg-white p-6 rounded-3xl border border-gray-100 flex items-center justify-between">
                    <div class="space-y-1.5">
                        ...
                        <div class="text-xs text-amber-600 flex items-center gap-1.5">
                            ...
                            <?php echo e($pendingOrdersCount + $processingOrdersCount); ?> pesanan berjalan
                        </div>
                    </div>
                ...
                <div class="bg-white p-6 rounded-3xl border border-gray-100 flex items-center justify-between">
                    <div class="space-y-1.5">
                        ...
                        <h3 class="text-2xl sm:text-3xl font-semibold text-gray-900 tracking-tight">
                            <?php echo e($totalOrders); ?> <span class="text-sm font-normal text-gray-400">Order</span>
                        </h3>
                ...
                <div class="bg-white p-6 rounded-3xl border border-gray-100 flex items-center justify-between">
                    <div class="space-y-1.5">
                        ...
                        <h3 class="text-2xl sm:text-3xl font-semibold text-gray-900 tracking-tight">
                            <?php echo e($totalProducts); ?> <span class="text-sm font-normal text-gray-400">Produk</span>
                        </h3>
                ...
                <div class="lg:col-span-4 bg-white p-6 sm:p-7 rounded-3xl border border-gray-100 flex flex-col justify-between space-y-5">
                    ...
                    <div class="space-y-3.5">
                        <div class="p-4 bg-gray-50 rounded-2xl space-y-1">
                            ...
                            <div class="text-xl font-semibold text-gray-900">Rp <?php echo e(number_format($grossRevenue, 0, ',', '.')); ?></div>
                        ...
                        <div class="space-y-2 text-xs">
                            ...
                            <div class="w-full bg-gray-100 h-2.5 rounded-full overflow-hidden flex">
                                ...
                                <div class="bg-[#b58d17] h-full transition-all duration-500" style="width: <?php echo e($pendingPct); ?>%" title="Pending: <?php echo e($pendingPct); ?>%"></div>
                            </div>
                            <div class="flex justify-between text-xs text-gray-400 pt-0.5">
                                ...
                                <span class="flex items-center gap-1"><span class="w-2 h-2 rounded-full bg-[#b58d17]"></span> Rp <?php echo e(number_format($pendingRevenue, 0, ',', '.')); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-2 pt-1 border-t border-gray-100">
                            <div class="p-3 bg-gray-50 rounded-xl">
                                ...
                                <span class="text-xs font-medium text-gray-800">Rp <?php echo e(number_format($averageOrderValue, 0, ',', '.')); ?></span>
                            </div>
                            <div class="p-3 bg-gray-50 rounded-xl">
                                <span class="text-xs text-gray-400 block">Parfum Terjual</span>
                                <span class="text-xs font-medium text-gray-800"><?php echo e($totalItemsSold); ?> Botol/Pcs</span>
                            </div>
                        </div>
                    </div>

                    <a href="<?php echo e(route('orders.index')); ?>" class="inline-flex items-center justify-center gap-1.5 w-full py-2.5 px-4 bg-gray-100 hover:bg-black hover:text-white transition-colors text-gray-800 rounded-xl text-xs font-medium">
            ...
            <div class="bg-white rounded-3xl border border-gray-100 overflow-hidden">
                <div class="p-6 sm:p-7 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <a href="<?php echo e(route('orders.index')); ?>" class="inline-flex items-center gap-1.5 px-4 py-2 bg-gray-100 hover:bg-black hover:text-white transition-colors text-gray-800 rounded-xl text-xs font-medium">
                        Lihat Semua Pesanan
                        <span class="px-1.5 py-0.5 rounded-md bg-gray-200 text-gray-700 text-xs"><?php echo e($totalOrders); ?></span>
                    </a>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="hover:bg-gray-50/70 transition-colors">
                                    <td class="p-4">
                                        <div class="font-medium text-gray-900">#<?php echo e($order->id); ?></div>
                                        <div class="text-xs text-gray-400 mt-0.5"><?php echo e($order->created_at->format('d M Y, H:i')); ?></div>
                                    </td>
                                    ...
                                    <td class="p-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="min-w-0">
                                                <div class="font-medium text-gray-900 truncate"><?php echo e($order->customer_name ?: 'Pelanggan Online'); ?></div>
                                                <?php if($order->customer_phone): ?>
                                                    <a href="https://wa.me/<?php echo e($phoneClean); ?>" target="_blank" class="inline-flex items-center gap-1 text-xs text-emerald-600 hover:text-emerald-700 mt-0.5">
                                    ...
                                    <td class="p-4 text-xs text-gray-600">
                                        <span class="font-medium text-gray-800"><?php echo e($itemsCount); ?> pcs</span>
                                        <div class="text-gray-400 mt-0.5 max-w-xs truncate" title="<?php echo e($itemsList->pluck('name')->join(', ')); ?>">
                                            <?php echo e($itemsList->pluck('name')->join(', ') ?: 'Pesanan langsung'); ?>

                                        </div>
                                    </td>

                                    <td class="p-4 font-medium text-gray-900">Rp <?php echo e(number_format($order->total_price, 0, ',', '.')); ?></td>
                ...
                <?php if($recentOrders->count() > 0): ?>
                    <div class="p-4 border-t border-gray-100 flex items-center justify-between text-xs text-gray-500">
                        <span>Menampilkan <?php echo e($recentOrders->count()); ?> transaksi terbaru</span>
                        <a href="<?php echo e(route('orders.index')); ?>" class="inline-flex items-center gap-1 font-medium text-black hover:text-[#b58d17] transition-colors">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <a href="<?php echo e(route('orders.index')); ?>" class="p-4 bg-white hover:bg-black hover:text-white transition-colors rounded-2xl border border-gray-100 flex items-center gap-3 group">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="p-4 bg-white hover:bg-black hover:text-white transition-colors rounded-2xl border border-gray-100 flex items-center gap-3 group">
                ...
                <a href="<?php echo e(route('brands.index')); ?>" class="p-4 bg-white hover:bg-black hover:text-white transition-colors rounded-2xl border border-gray-100 flex items-center gap-3 group">
                ...
                <a href="<?php echo e(route('reviews.index')); ?>" class="p-4 bg-white hover:bg-black hover:text-white transition-colors rounded-2xl border border-gray-100 flex items-center gap-3 group">
...
<?php endif; ?><?php /**PATH C:\Users\Ghani\kelompok parfum\Perfu.me\resources\views/dashboard.blade.php ENDPATH**/ ?>