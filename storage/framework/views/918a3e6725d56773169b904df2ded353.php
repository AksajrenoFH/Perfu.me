            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div class="bg-white p-6 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.02)] border border-gray-100 flex items-center justify-between group hover:border-black transition-all">
                    <div class="space-y-1">
                        ...
                        <h3 class="text-3xl font-black text-gray-900"><?php echo e($totalProducts); ?></h3>
                ...
                <div class="bg-white p-6 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.02)] border border-gray-100 flex items-center justify-between group hover:border-[#D4AF37] transition-all">
                    <div class="space-y-1">
                        ...
                        <h3 class="text-3xl font-black text-gray-900"><?php echo e($totalBrands); ?></h3>
                ...
                <div class="bg-white p-6 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.02)] border border-gray-100 flex items-center justify-between group hover:border-emerald-500 transition-all">
                    <div class="space-y-1">
                        ...
                        <h3 class="text-3xl font-black text-emerald-600"><?php echo e($totalStock); ?> <span class="text-xs font-bold text-gray-400">Pcs</span></h3>
                        <span class="text-[11px] font-bold text-emerald-600 flex items-center gap-1 pt-1">
                ...
                <div class="bg-white p-6 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.02)] border border-gray-100 flex items-center justify-between group hover:border-purple-500 transition-all">
                    <div class="space-y-1">
                        ...
                        <h3 class="text-3xl font-black text-gray-900"><?php echo e($averageRating); ?> <span class="text-xs font-bold text-gray-400">/ 5.0</span></h3>
                        <span class="text-[11px] font-bold text-purple-600 flex items-center gap-1 pt-1">
                            ...
                            Dari <?php echo e($totalReviews); ?> ulasan
                        </span>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.02)] border border-gray-100 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-2.5">
                        <a href="<?php echo e(route('products.index')); ?>" class="p-3 bg-gray-50 hover:bg-black hover:text-white rounded-2xl border border-gray-100 text-xs font-bold transition-all flex flex-col items-center justify-center text-center gap-1 group">
                        ...
                        <a href="<?php echo e(route('brands.index')); ?>" class="p-3 bg-gray-50 hover:bg-black hover:text-white rounded-2xl border border-gray-100 text-xs font-bold transition-all flex flex-col items-center justify-center text-center gap-1 group">
                            <svg class="w-5 h-5 text-gray-600 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
                            Kelola Brand
                        </a>
                        <a href="<?php echo e(route('reviews.index')); ?>" class="p-3 bg-gray-50 hover:bg-black hover:text-white rounded-2xl border border-gray-100 text-xs font-bold transition-all flex flex-col items-center justify-center text-center gap-1 group col-span-2">
                ...
                <div class="bg-white p-6 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.02)] border border-gray-100 space-y-4">
                    ...
                    <div class="space-y-3 text-xs text-gray-600">
                        <div class="p-3 bg-gray-50 rounded-2xl border border-gray-100 space-y-1">
                            <strong class="text-gray-900 font-bold block">Login sebagai: <?php echo e(Auth::user()->name); ?></strong>
                            <p class="text-gray-500 truncate"><?php echo e(Auth::user()->email); ?></p>
                        </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            new Chart(ctxBar, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Jumlah Data',
                        data: [<?php echo e($totalProducts); ?>, <?php echo e($totalBrands); ?>, <?php echo e($totalReviews); ?>],
            ...
            new Chart(ctxDonut, {
                ...
                data: {
                    datasets: [{
                        data: [<?php echo e($categoryOriginal); ?>, <?php echo e($categoryRefill); ?>],
