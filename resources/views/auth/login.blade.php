...
<body class="antialiased bg-gray-50">
    ...
    <div class="fixed inset-0 w-full h-full grid grid-cols-1 lg:grid-cols-2" x-data="{ 
             activeSlide: 0, 
             images: [
                 '{{ asset('storage/image/DSC00068.JPG') }}',
                 '{{ asset('storage/image/DSC00047.JPG') }}',
                 '{{ asset('storage/image/Dinamist-parfu.me.JPG') }}'
             ],
             quotes: [
        ...
        {{-- KOLOM KIRI: Luxury Mesh Gradient & Interactive Slider --}}
        <div
            ...
            {{-- Background Image Layer dengan Smooth Crossfade --}}
            ...
            {{-- Bottom Dynamic Quote dengan Efek Elegan --}}
            <div class="relative z-10 max-w-lg">
                ...
                <p class="text-xs text-gray-400 font-medium tracking-wide">© {{ date('Y') }} Perfu.me</p>
            </div>
        </div>

        {{-- KOLOM KANAN: Form Login Clean High-End --}}
        <div class="flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 bg-white h-full overflow-y-auto">
            <div class="max-w-md w-full mx-auto my-auto">
                ...
                {{-- Session Status / Error Message (jika ada) --}}
                @if ($errors->any())
