<div class="{{ request('drawer') ? 'py-6' : 'py-10' }} bg-[#F4F5F7] min-h-screen">
    <div class="{{ request('drawer') ? 'max-w-full' : 'max-w-3xl' }} mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    >
                        @foreach([
                            ...
                            <option
                                value="{{ $value }}"
                                @selected(old('rating', $review->rating) == $value)
                            >
                                {{ $label }}
                            </option>
                        @endforeach
