<x-app-layout>
    <div x-data="{ deleteModalOpen: false, deleteUrl: '', brandName: '' }" class="min-h-screen bg-[#F8F9FA] py-8">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-50 text-xs font-medium text-gray-600">
                            ...
                            <tr class="hover:bg-gray-50/60 transition-colors group">
                                ...
                                <!-- Nama Brand -->
                                <td class="py-4 px-6">
                                    <span class="font-bold text-gray-900 text-sm tracking-tight">{{ $brand->name }}</span>
                                </td>
                                ...
                                <td class="py-4 px-6 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('brands.edit', $brand->id) }}" class="px-3 py-1.5 bg-[#D4AF37]/10 hover:bg-[#D4AF37] hover:text-white text-[#D4AF37] rounded-xl transition-all shadow-xs text-xs font-bold">Edit</a>
