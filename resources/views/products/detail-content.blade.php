<div x-data="{
    ...
    hoverImage: '{{ $product->image_hover ? asset('storage/' . $product->image_hover) : '' }}',
    activeImage: '{{ $product->image ? asset('storage/' . $product->image) : ($product->image_hover ? asset('storage/' . $product->image_hover) : '') }}',
        ...
        <div
            ...
            <div class="flex items-center gap-2 text-gray-500 font-medium">
                <a href="{{ route('products.index') }}" class="hover:text-black transition"
                    @if (request('drawer')) target="_parent" @endif>
                    Daftar Produk
                </a>
                <span>/</span>
                ...
                <div class="lg:col-span-5 p-6 lg:p-8 space-y-4 lg:sticky lg:top-8 lg:self-start">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="w-full h-[380px] sm:h-[420px] rounded-2xl overflow-hidden bg-gray-50 border border-gray-100 relative group cursor-pointer shadow-inner"
                            ...
                            @if ($product->image || $product->image_hover)
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        ...
                        <a href="{{ route('products.edit', ['product' => $product->id, 'drawer' => request('drawer')]) }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="p-4 rounded-xl border border-gray-100 bg-white space-y-1 shadow-2xs">
                            ...
                            <div class="flex items-center gap-2">
                                <span
                                    class="w-2.5 h-2.5 rounded-full {{ $product->stock < 10 ? 'bg-red-500 animate-pulse' : 'bg-emerald-500' }}"></span>

                                <span
                                    class="font-extrabold text-sm {{ $product->stock < 10 ? 'text-red-600' : 'text-gray-900' }}">
                                    {{ $product->stock ?? 0 }} Unit Tersedia
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div x-show="activeTab === 'description'"
                            ...
                            <div>
                                ...
                                <p class="whitespace-pre-line">
                                    {{ $product->composition ?? 'Belum ada informasi komposisi.' }}
                                </p>
                            </div>
                        ...
                        <div x-show="activeTab === 'notes'" class="space-y-4 min-h-[180px]">
                            ...
                            <div class="p-4 rounded-2xl bg-blue-50/60 border border-blue-100">
                                ...
                                <p class="text-xs text-gray-700 whitespace-pre-line pl-11">
                                    {{ $product->top_note ?? 'Belum ada informasi top note.' }}
                                </p>
                            </div>
                            ...
                            <div class="p-4 rounded-2xl bg-purple-50/60 border border-purple-100">
                                ...
                                <p class="text-xs text-gray-700 whitespace-pre-line pl-11">
                                    {{ $product->middle_note ?? 'Belum ada informasi middle note.' }}
                                </p>
                            </div>
                            ...
                            <div class="p-4 rounded-2xl bg-amber-50/60 border border-amber-100">
                                ...
                                <p class="text-xs text-gray-700 whitespace-pre-line pl-11">
                                    {{ $product->base_note ?? 'Belum ada informasi base note.' }}
                                </p>
                            </div>
                        ...
                        <div x-show="activeTab === 'specs'" class="text-xs text-gray-600 space-y-2.5 min-h-[180px]">
                            ...
                            <div class="flex justify-between gap-4 py-2 border-b border-gray-100">
                                ...
                                <span
                                    class="font-bold {{ $product->is_best_seller ? 'text-[#D4AF37]' : 'text-gray-400' }}">
