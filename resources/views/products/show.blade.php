<x-app-layout>
    <!-- Alpine.js State untuk Modal Lightbox & Hapus -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex items-center justify-between bg-white px-6 py-3 rounded-2xl shadow-xs border border-gray-100 text-xs">
                <div class="flex items-center gap-2 text-gray-500 font-medium">
                    <a href="{{ route('products.index') }}" class="hover:text-black transition">Daftar Produk</a>
                    <span>/</span>
                ...
                <a href="{{ route('products.index') }}" class="px-4 py-2 bg-gray-100 hover:bg-black hover:text-white text-gray-700 rounded-xl font-bold transition-all flex items-center gap-1.5">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-0 lg:divide-x divide-gray-100">
                    ...
                    <div class="lg:col-span-5 p-6 lg:p-8 space-y-4 lg:sticky lg:top-8 lg:self-start">
                        ...
                        <div class="flex items-center gap-3 pt-2">
                            <a href="{{ route('products.edit', $product->id) }}" class="flex-1 py-3 bg-black hover:bg-gray-800 text-white text-center rounded-xl text-xs font-bold tracking-wider uppercase transition-all shadow-sm flex items-center justify-center gap-2">
